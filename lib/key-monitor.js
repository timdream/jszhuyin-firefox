...
var KeyMonitor = function KeyMonitor(frontend) {
  this.focusedWindow = null;
  this.blockKeyUpDownEvent = false;

  this.frontend = frontend;
};

KeyMonitor.prototype = {
  start: function km_start() {
    this.focusedWindow = getMostRecentBrowserWindow();
    this.focusedWindow.addEventListener('keydown', this, true);
    this.focusedWindow.addEventListener('keyup', this, true);
    this.focusedWindow.addEventListener('keypress', this, true);
  },

  stop: function km_stop() {
    this.focusedWindow.removeEventListener('keydown', this, true);
    this.focusedWindow.removeEventListener('keyup', this, true);
