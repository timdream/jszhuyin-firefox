...
exports.IMEDisplayManager = {
  ...
  start: function idm_start() {
    ...
    // XXX: should be removed once the SDK lands the patch and the new version
    //      is released.
    if (!('focus' in this.panel)) {
      throw new Error('Your Add-on SDK doesn\'t support panel.focus. ' +
                      'Please see bug 852023 and patch your add-on SDK ' +
                      'temporary for the feature.');
    }
  },
