...
var IMEDisplayManager = function IMEDisplayManager(frontend) {
  this.panel = null;
...
IMEDisplayManager.prototype = {
  ...
  sendMessage: function idm_sendMessage(name, data) {
    if (!this.panel) {
      throw 'IMEDisplayManager.start() needs to be run first.';
    }
...
exports.IMEDisplayManager = IMEDisplayManager;
