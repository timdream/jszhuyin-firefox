...
// away.
// The method here does not track the composition status. Caller should do that
// itself.
  ...
  function th_sendKeyEvent(element, type, text, locale) {
    ...
    switch (type) {
      case 'compositionstart':
        utils.sendCompositionEvent('compositionstart', text, locale);

        break;

      case 'compositionupdate':
        // During the composition session, the compositionupdate MUST be
        // dispatched before the beforeinput and input events are sent.
        //  https://dvcs.w3.org/hg/dom3events/raw-file/tip/html/DOM3-Events.html
        //  #h5_events-composition-event-input-events
        utils.sendCompositionEvent('compositionupdate', text, locale);
      ...
      case 'compositionend':
        ...
        utils.sendCompositionEvent('compositionend', text, locale);
